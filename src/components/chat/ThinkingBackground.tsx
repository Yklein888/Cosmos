...
// COSMOS particles — small dots emitted from groups that fly to letter positions
...
export function ThinkingBackground() {
    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            // ===== 1. CONVERSATION ARCS between groups (unchanged by COSMOS) =====
            ...
            // ===== 2. WITHIN-GROUP LINKS (unchanged by COSMOS) =====
            ...
            // ===== 4. COSMOS PARTICLES (emitted from groups, fly to letter positions) =====
            if (formT > 0) {
