    ...
    >
      ...
      <div className="flex items-end gap-2">
        ...
        <textarea
          ...
          onPaste={handlePaste}
          placeholder={isLoading ? 'Type to queue a message...' : (images.length > 0 ? 'Add a message about the attachment...' : (agents.length > 0 ? 'Message the team... (@ to mention an agent)' : 'Send a message to COSMOS...'))}
          rows={1}
