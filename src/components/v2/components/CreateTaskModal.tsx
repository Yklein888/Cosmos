...
export function CreateTaskModal({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center">
      <div className="bg-cosmos-bg border border-cosmos-border rounded-2xl w-[640px] max-h-[80vh] flex flex-col shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-cosmos-border">
        ...
        {/* Step indicator */}
        <div className="flex items-center border-b border-cosmos-border">
          {STEPS.map((s, i) => {
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-5">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-3 p-3 rounded-lg border text-left transition-colors ${
                        template === tmpl.id
                          ...
                          : 'bg-cosmos-card border-cosmos-border hover:border-zinc-600'
                      }`}
                    >
              ...
              <div className="space-y-3">
                ...
                <div className="bg-cosmos-card border border-cosmos-border rounded-xl overflow-hidden">
                  ...
                  {jiraEnabled && jiraConnected && (
                    <div className="px-4 pb-4 pt-3 space-y-3 border-t border-cosmos-border mx-4">
                      <FormSelect
                        label="Project"
          ...
          {step === 2 && (
            <>
              ...
              {interval !== 'manual' && (
                <div className="flex items-center justify-between p-3 bg-cosmos-card border border-cosmos-border rounded-lg">
                  <div>
              ...
              <div className="p-3 bg-zinc-900/50 border border-cosmos-border rounded-lg">
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-cosmos-card border border-cosmos-border rounded-lg space-y-2">
                  ...
                  {description && (
                    <div className="pt-1 border-t border-cosmos-border">
                ...
                <div className="p-3 bg-cosmos-card border border-cosmos-border rounded-lg space-y-2">
                  ...
                  {enabledMcpServers.length > 0 && (
                    <div className="pt-1.5 border-t border-cosmos-border">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between px-6 py-3 border-t border-cosmos-border">
          <button
