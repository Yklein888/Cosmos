    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-lg mx-4 bg-cosmos-card border border-cosmos-border rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          {/* Conversation stats */}
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-cosmos-bg border border-cosmos-border">
            ...
            <div className="w-px h-3 bg-cosmos-border" />
            <div className="flex items-center gap-1.5">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {uniqueTools.map((tool) => (
                  <span
                    key={tool}
                    className="px-2 py-0.5 rounded-md bg-cosmos-bg border border-cosmos-border text-[10px] text-zinc-400"
                  >
                    {tool}
                  </span>
                ))}
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-cosmos-border bg-cosmos-bg/50">
          <span className="text-[10px] text-zinc-600">
            {isGenerating ? 'COSMOS is analyzing...' : 'Generates task + workflow from conversation'}
          </span>
