...
export function TaskDetailPanel({ task, onClose }: Props) {
  ...
  const handleExportFile = useCallback(async () => {
    ...
    const filePath = await api.dialog.saveFile({
      defaultPath: `${sanitizedTitle}.COSMOS`,
      filters: [{ name: 'COSMOS Task', extensions: ['COSMOS'] }],
    })
    if (filePath) {
  ...
  return (
    <div className="w-[360px] border-l border-cosmos-border flex flex-col bg-cosmos-bg flex-shrink-0">
      {/* Header */}
      <div className="px-4 py-3 border-b border-cosmos-border flex-shrink-0">
        ...
        <div className="relative">
          ...
          {showRunMenu && task.status !== 'running' && (
            <div className="absolute top-full left-0 right-0 mt-1 bg-zinc-800 border border-cosmos-border rounded-lg shadow-xl z-10 overflow-hidden">
              <button
                onClick={() => {
              ...
              {task.schedule.interval !== 'manual' && (
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 py-2 hover:bg-zinc-700 transition-colors text-left border-t border-cosmos-border"
                >
      ...
      {/* Tabs */}
      <div className="flex border-b border-cosmos-border flex-shrink-0">
        {TABS.map((t) => (
          <button
            key={t}
            onClick={() => setTab(t)}
        ...
        {tab === 'Overview' && (
          <>
            ...
            <div>
              ...
              <div className="p-3 bg-cosmos-card border border-cosmos-border rounded-lg space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <select
                    ...
                    className="bg-zinc-800 border border-cosmos-border rounded px-2 py-1 text-xs text-white outline-none focus:border-blue-500 cursor-pointer"
                  >
              ...
              {task.integrations.length > 0 ? (
                <div className="space-y-2">
                  {jiraIntegration && jiraIntegration.config.type === 'jira' && (
                    <div className="p-3 bg-cosmos-card border border-cosmos-border rounded-lg">
            ...
            <div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-zinc-300 hover:text-white hover:border-zinc-600 transition-colors"
              >
            ...
            <div>
              ...
              {!isPro ? (
                <div className="space-y-2">
                  <button
                    disabled
                    className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-zinc-500 opacity-50 cursor-not-allowed"
                  >
                    <Icon icon="lucide:download" className="text-zinc-600 text-sm" />
                    Export as .COSMOS file
                  </button>
                  <button
                    disabled
                    className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-zinc-500 opacity-50 cursor-not-allowed"
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    {exportSuccess ? 'Exported!' : 'Export as .COSMOS file'}
                  </button>
                  <button
                ...
                <div className="p-3 bg-cosmos-card border border-cosmos-border rounded-lg flex items-start gap-2">
            ...
            {/* Danger zone */}
            <div className="pt-2 border-t border-cosmos-border">
              <button
            ...
            {task.runs[0] ? (
              <>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-1.5">
                      {task.runs[0].actions.map((action, i) => {
                        ...
                        return (
                          <div key={i} className="flex items-start gap-2 p-2 bg-cosmos-card border border-cosmos-border rounded-lg">
                ...
                {task.runs[0].logs && task.runs[0].logs.length > 0 && (
                  <details className="pt-2 border-t border-cosmos-border">
