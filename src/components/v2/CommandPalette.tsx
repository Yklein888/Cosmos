...
export function CommandPalette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* Palette */}
      <div
        className="relative w-full max-w-lg bg-cosmos-card border border-cosmos-border rounded-xl shadow-2xl overflow-hidden"
        onClick={(e) => e.stopPropagation()}
        onKeyDown={handleKeyDown}
      >
        {/* Search input */}
        <div className="flex items-center gap-3 px-4 py-3 border-b border-cosmos-border">
        ...
        {/* Footer hint */}
        <div className="flex items-center gap-3 px-4 py-2 border-t border-cosmos-border">
