...
export default function LoginPage() {
  ...
  const handleGetLicense = () => {
    api.dialog.openExternal('https://COSMOS.net')
  }
    ...
    <div className="flex-1 flex items-center justify-center overflow-y-auto">
      <div className="w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-white mb-1">Welcome to COSMOS</h1>
            ...
            <div className="flex border-b border-cosmos-border">
              <button
                ...
                className={`flex-1 px-4 py-3 text-xs font-bold uppercase tracking-widest transition-colors ${
                  mode === 'login'
                    ? 'text-white bg-cosmos-bg border-b-2 border-blue-500'
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 bg-cosmos-bg border border-cosmos-border rounded-lg text-sm text-white placeholder-zinc-600 outline-none focus:border-blue-500 disabled:opacity-50 transition-colors"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={isValidating}
                    className="w-full pl-9 pr-3 py-2.5 bg-cosmos-bg border border-cosmos-border rounded-lg text-sm text-white placeholder-zinc-600 outline-none focus:border-blue-500 disabled:opacity-50 font-mono transition-colors"
            ...
            {mode === 'login' && (
              <div className="text-center space-y-1.5">
                ...
                >
                  Don't have a license key? Get one at COSMOS.net
                </button>
                <button
              ...
              <div
                ...
                className={`p-4 rounded-xl border transition-colors ${
                  (mode === 'login' && tier === 'pro') || (mode === 'free' && tier === 'free')
                    ...
                    : 'border-cosmos-border bg-cosmos-card'
                }`}
              >
