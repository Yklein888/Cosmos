...
function ConversationSidebar() {
  ...
  return (
    <div className="w-56 border-r border-cosmos-border bg-cosmos-bg flex flex-col flex-shrink-0">
      <div className="p-3 border-b border-cosmos-border">
        <button
          onClick={() => createConversation()}
          className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-cosmos-card border border-cosmos-border hover:border-zinc-600 rounded-lg text-xs font-medium text-zinc-300 transition-colors"
        >
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        {conversations.map((conv) => (
          ...
          >
            {editingId === conv.id ? (
              <div className="px-3 py-2.5 border-b border-cosmos-border/50">
                <input
                  ref={editInputRef}
                  value={editTitle}
              ...
              <button
                ...
                className={`w-full text-left px-3 py-2.5 text-xs transition-colors border-b border-cosmos-border/50 ${
...
function TerminalControls({ onSaveAsTask }: { onSaveAsTask: () => void }) {
  ...
  return (
    <div className="flex items-center gap-1 px-4 py-1.5 border-b border-cosmos-border bg-cosmos-card/30 flex-shrink-0">
      <button
      ...
      <div className="w-px h-3 bg-cosmos-border mx-1" />
      <button
...
function TerminalInput() {
  ...
  return (
    <div
      className={`border-t border-cosmos-border bg-[#0c0c0e] px-4 py-3 flex-shrink-0 transition-colors ${
          ...
          {images.map((img, i) => (
            <div key={i} className="relative group">
              {img.mediaType === 'application/pdf' ? (
                <div className="h-14 w-14 flex items-center justify-center rounded-lg border border-cosmos-border bg-zinc-800">
                ...
                <img
                  ...
                  className="h-14 w-14 object-cover rounded-lg border border-cosmos-border"
                />
              )}
              <button
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Agent Status Bar */}
        <div className="flex items-center justify-between px-4 py-2 border-b border-cosmos-border bg-cosmos-card/30 flex-shrink-0">
