  ...
  return (
    <div className="flex items-center justify-between p-3 bg-cosmos-card border border-cosmos-border rounded-lg">
      ...
      <div className="flex items-center gap-2">
        {status === 'checking' && (
          <div className="w-4 h-4 border-2 border-cosmos-accent border-t-transparent rounded-full animate-spin" />
        )}
        {status === 'found' && (
        ...
        {status === 'not_found' && (
          <button
            ...
            className="px-3 py-1 text-xs font-medium text-cosmos-accent hover:bg-blue-500/10 rounded-lg transition-colors"
          >
            Locate
          </button>
        )}
...
function CliSetupCard() {
  ...
  return (
    <div className="p-6 bg-cosmos-card border border-cosmos-border rounded-xl">
...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      {/* Progress bar header */}
      <div className="h-12 border-b border-cosmos-border flex items-center px-6 flex-shrink-0">
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            <div className="w-40 h-1 bg-zinc-800 rounded-full overflow-hidden">
              <div
                className="h-full bg-cosmos-accent rounded-full transition-all duration-700"
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        <div className="max-w-2xl mx-auto py-12 px-6">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-6 h-6 bg-cosmos-accent rounded-full flex items-center justify-center">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${depsFound ? 'bg-cosmos-accent' : 'bg-zinc-700'}`}>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${setupStatus === 'ready' ? 'bg-cosmos-success' : 'bg-zinc-700'}`}>
