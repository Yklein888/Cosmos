...
function AgentCard({ agent, status }: { agent: AgentDefinition; status: AgentStatus }) {
  ...
  return (
    <button
      ...
      className="w-full p-4 bg-cosmos-card border border-cosmos-border rounded-xl hover:border-cosmos-accent/40 hover:shadow-[0_0_16px_rgba(99,102,241,0.1)] transition-all text-left"
    >
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        <div className="p-8 max-w-2xl mx-auto">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-16 h-16 bg-gradient-to-br from-cosmos-accent/20 to-cosmos-accent-2/20 rounded-2xl flex items-center justify-center border border-cosmos-accent/20">
              <Icon icon="lucide:orbit" className="text-cosmos-accent text-3xl" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-white">Welcome to COSMOS</h1>
          ...
          <div className="space-y-6">
            <button
              ...
              className="w-full p-6 bg-cosmos-card border border-dashed border-zinc-700 rounded-xl hover:border-cosmos-accent/50 transition-all text-center"
            >
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          <div className="p-6">
            {/* Hero Banner */}
            <div className="relative p-6 bg-gradient-to-br from-cosmos-surface to-cosmos-card border border-cosmos-border rounded-2xl mb-6 overflow-hidden">
              {/* Decorative nebula background */}
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 right-0 w-64 h-64 opacity-[0.06]">
                  <svg viewBox="0 0 200 200" className="w-full h-full">
                    <circle cx="100" cy="100" r="80" stroke="#6366f1" fill="none" strokeWidth="0.5" />
                    <circle cx="100" cy="100" r="60" stroke="#a855f7" fill="none" strokeWidth="0.5" />
                    <circle cx="100" cy="100" r="40" stroke="#22d3ee" fill="none" strokeWidth="0.5" />
                  </svg>
                </div>
                <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-cosmos-accent/5 blur-3xl" />
              </div>
              ...
              <div className="relative">
                ...
                <h1 className="text-3xl font-bold text-cosmos-text mb-2 leading-tight">
                  The Visual Layer for{' '}
                  <span className="bg-gradient-to-r from-cosmos-accent to-cosmos-accent-2 bg-clip-text text-transparent">
                    Claude Code
                  </span>
                </h1>
              ...
              <div className="relative grid grid-cols-3 gap-4 mt-6">
                <div className="p-3 bg-cosmos-bg/50 border border-cosmos-border rounded-lg">
            ...
            <div className="mb-6">
              ...
              {agents.length > 0 ? (
                ...
                <div className="p-6 bg-cosmos-card border border-cosmos-border rounded-xl text-center">
        ...
        {/* Right Column */}
        <div className="w-[340px] border-l border-cosmos-border bg-cosmos-bg overflow-y-auto custom-scrollbar flex-shrink-0">
      ...
      {/* Bottom Status Bar */}
      <div className="h-8 border-t border-cosmos-border bg-cosmos-card/50 flex items-center px-4 flex-shrink-0">
