...
export function AddAgentDialog({ open, onClose, onAdd, existingIds }: AddAgentDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-cosmos-bg border border-cosmos-border rounded-xl shadow-2xl w-[640px] max-h-[80vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-cosmos-border">
        ...
        {/* Tabs */}
        <div className="flex border-b border-cosmos-border px-5">
          <button
          ...
          {tab === 'templates' ? (
            <div className="p-5">
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-3 py-2 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-white placeholder-zinc-600 outline-none focus:border-blue-500/50"
                />
              </div>
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center gap-3 p-3 rounded-lg border text-left transition-all ${
                              alreadyAdded
                                ? 'border-cosmos-border/50 opacity-40 cursor-not-allowed'
                                : 'border-cosmos-border hover:border-zinc-600 hover:bg-zinc-800/50'
                            }`}
                          >
            ...
            <div className="p-5 space-y-4 max-w-md">
              ...
              {isPro ? (
                <div className="p-3 bg-blue-500/5 border border-blue-500/20 rounded-lg space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-1.5 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-white placeholder-zinc-600 outline-none focus:border-blue-500/50 disabled:opacity-50"
                    />
                    {isGenerating ? (
                      <button
                ...
                <div className="p-3 bg-zinc-800/30 border border-cosmos-border rounded-lg">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-white placeholder-zinc-600 outline-none focus:border-blue-500/50"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-white placeholder-zinc-600 outline-none focus:border-blue-500/50 resize-none"
                />
              </div>
              ...
              {/* Preview */}
              {customName && (
                <div className="flex items-center gap-3 p-3 rounded-lg border border-cosmos-border bg-cosmos-card/50">
        ...
        {/* Footer */}
        {tab === 'custom' && (
          <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-cosmos-border">
            <button
              onClick={onClose}
