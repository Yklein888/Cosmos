    ...
    <div>
      ...
      <div className="flex gap-1.5">
        ...
        <button
          ...
          className="flex items-center gap-1 px-2.5 py-1.5 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors flex-shrink-0"
    ...
    <>
      <button
        ...
        className={`flex items-center justify-center w-7 h-7 rounded-md border transition-colors flex-shrink-0 ${
          anchorEl ? 'bg-blue-600/20 border-blue-500/30 text-blue-400' : 'bg-cosmos-card border-cosmos-border text-zinc-500 hover:text-white hover:border-zinc-600'
        }`}
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="flex items-center justify-center w-7 h-7 rounded-md border bg-cosmos-card border-cosmos-border text-purple-400 hover:text-purple-300 hover:border-purple-500/30 transition-colors flex-shrink-0"
    ...
    <div className="mt-1.5 p-2.5 bg-purple-500/5 border border-purple-500/20 rounded-lg">
      ...
      <div className="flex gap-1.5">
        <input
          ...
          className="flex-1 min-w-0 bg-cosmos-card border border-cosmos-border rounded-md px-2 py-1 text-[10px] text-white placeholder-zinc-600 outline-none focus:border-purple-500/50 disabled:opacity-50"
          autoFocus
        />
        <button
                ...
                <button
                  ...
                  className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase transition-colors ${
                    param.format === fmt
                      ...
                      : 'bg-cosmos-card border border-cosmos-border text-zinc-500 hover:text-white'
                  }`}
                >
                  {fmt}
                </button>
...
function StepResultPreview({ result }: { result: WorkflowStepResult }) {
  ...
  return (
    <div className={`p-3 rounded-lg border ${
      ...
      : 'bg-zinc-800/50 border-cosmos-border'
    }`}>
      <div className="flex items-center justify-between mb-1.5">
...
export function WorkflowNodeConfig() {
  ...
  return (
    <div className="w-80 border-l border-cosmos-border flex flex-col bg-cosmos-bg flex-shrink-0">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-4">
        ...
        {data.type === 'mcp_tool' && data.toolId && (
          <div>
            ...
            <div className="p-3 bg-cosmos-card border border-cosmos-border rounded-lg space-y-1.5">
        ...
        {!isStart && !isEnd && (
          <div>
            ...
            <div className="p-3 bg-cosmos-card border border-cosmos-border rounded-lg space-y-3">
              <FormToggle
                label="Auto-Retry"
