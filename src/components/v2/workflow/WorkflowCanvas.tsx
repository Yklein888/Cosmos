    ...
    <div className="flex-1 relative">
      ...
      >
        ...
        <MiniMap
          ...
          className="!bg-cosmos-card !border !border-cosmos-border !rounded-lg"
          ...
          <div className="text-center max-w-xs">
            ...
            <div className="flex items-center gap-2 pointer-events-auto">
              <button
                ...
                className="flex-1 px-4 py-2 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors"
              >
              ...
              <button
                ...
                disabled={!isPro}
                className={`flex-1 px-4 py-2 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-1.5 ${isPro ? 'bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-600/20' : 'bg-zinc-800 border border-cosmos-border text-zinc-500 cursor-not-allowed opacity-60'}`}
              >
      ...
      <div className="absolute top-4 left-4 flex flex-col gap-1.5">
        {/* Zoom controls */}
        <div className="flex flex-col bg-cosmos-card border border-cosmos-border rounded-lg overflow-hidden">
          <button onClick={handleZoomIn} title="Zoom In" className="px-2.5 py-2 text-zinc-400 hover:text-white hover:bg-zinc-800 transition-colors border-b border-cosmos-border">
            <Icon icon="lucide:plus" className="text-xs" />
          </button>
          <button onClick={handleZoomOut} title="Zoom Out" className="px-2.5 py-2 text-zinc-400 hover:text-white hover:bg-zinc-800 transition-colors border-b border-cosmos-border">
        ...
        <div className="flex flex-col bg-cosmos-card border border-cosmos-border rounded-lg overflow-hidden">
          <button
            ...
            disabled={!canUndo}
            title="Undo (Ctrl+Z)"
            className="px-2.5 py-2 text-zinc-400 hover:text-white hover:bg-zinc-800 disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-zinc-400 transition-colors border-b border-cosmos-border"
          >
        ...
        <button
          ...
          className="px-2.5 py-2 bg-cosmos-card border border-cosmos-border rounded-lg text-zinc-400 hover:text-white hover:bg-zinc-800 transition-colors"
        >
