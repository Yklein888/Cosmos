...
function ResultRow({ result, label, nodeType }: { result: WorkflowStepResult; label: string; nodeType?: string }) {
  ...
  return (
    <div className={`border rounded-lg transition-colors ${
      ...
      {expanded && (
        <div className="px-3 pb-2.5 border-t border-cosmos-border/50">
...
export function WorkflowResultsPanel({ onClose }: Props) {
  ...
  return (
    <div className="w-80 border-l border-cosmos-border flex flex-col bg-cosmos-bg flex-shrink-0">
      {/* Header */}
      <div className="px-4 py-3 border-b border-cosmos-border flex items-center justify-between flex-shrink-0">
      ...
      {isFinished && results.length > 0 && (
        <div className="px-4 py-2.5 border-t border-cosmos-border flex-shrink-0">
