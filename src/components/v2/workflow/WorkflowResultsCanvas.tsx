...
export function WorkflowResultsCanvas({ onClose }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-cosmos-bg">
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-3 border-b border-cosmos-border flex-shrink-0">
        ...
        {!resultData && !hasFailures ? (
          ...
          <div className="max-w-4xl mx-auto px-8 py-8">
            ...
            {showAllSteps && stepResults.length > 0 && (
              <div className="mt-8 pt-6 border-t border-cosmos-border">
...
function StepRow({ label, nodeType, duration, isOk, isFailed, error, output }: {
  ...
  return (
    <div className={`rounded-lg border ${isFailed ? 'border-red-500/20' : 'border-cosmos-border/50'}`}>
      ...
      {open && (
        <div className="px-3 pb-3 border-t border-cosmos-border/30">
