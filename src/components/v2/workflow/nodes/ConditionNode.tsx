...
export function ConditionNode({ data, selected }: ConditionNodeProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      <Handle type="target" position={Position.Top} className="!w-2.5 !h-2.5 !bg-amber-500 !border-2 !border-cosmos-bg" />
      ...
      <Handle
        ...
        id="no"
        className="!w-2.5 !h-2.5 !bg-red-500 !border-2 !border-cosmos-bg"
      />
