...
export function LoopNode({ data, selected }: LoopNodeProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      <Handle type="target" position={Position.Top} className="!w-2.5 !h-2.5 !bg-purple-500 !border-2 !border-cosmos-bg" />

      <div
        className={`w-[160px] bg-cosmos-card border-2 rounded-lg transition-all ${
          selected
      ...
      <Handle
        ...
        id="body"
        className="!w-2.5 !h-2.5 !bg-purple-500 !border-2 !border-cosmos-bg"
      />
      ...
      <Handle
        ...
        id="done"
        className="!w-2.5 !h-2.5 !bg-emerald-500 !border-2 !border-cosmos-bg"
        style={{ top: '50%' }}
      />
