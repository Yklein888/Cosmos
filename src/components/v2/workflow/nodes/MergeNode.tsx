  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <Handle
        ...
        id="input_1"
        className="!w-2.5 !h-2.5 !bg-indigo-500 !border-2 !border-cosmos-bg"
        style={{ left: '30%' }}
      />
      <Handle
        type="target"
      ...
      <div
        className={`w-[140px] bg-cosmos-card border-2 rounded-lg transition-all ${
          selected
      ...
      <Handle type="source" position={Position.Bottom} className="!w-2.5 !h-2.5 !bg-indigo-500 !border-2 !border-cosmos-bg" />
    </div>
  )
}
