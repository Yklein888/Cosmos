...
export function VariableNode({ data, selected }: VariableNodeProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      <Handle type="target" position={Position.Top} className="!w-2.5 !h-2.5 !bg-violet-500 !border-2 !border-cosmos-bg" />
      ...
      <Handle type="source" position={Position.Bottom} className="!w-2.5 !h-2.5 !bg-violet-500 !border-2 !border-cosmos-bg" />
    </div>
  )
}
