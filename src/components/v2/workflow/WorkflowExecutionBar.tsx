...
export function WorkflowExecutionBar({ onShowResults }: { onShowResults?: () => void } = {}) {
  ...
  return (
    <div className="border-t border-cosmos-border flex-shrink-0 bg-cosmos-bg">
      {/* Main bar */}
        ...
        {jiraProjects.length > 0 && (
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              disabled={isRunning}
              className="bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-zinc-300 px-2 py-1.5 outline-none hover:border-zinc-600 focus:border-blue-500/50 transition-colors disabled:opacity-50 cursor-pointer"
            >
              {jiraProjects.map((p) => (
            ...
            <>
              {isFinished && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-cosmos-card border border-cosmos-border rounded-lg text-xs text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors"
                >
              ...
              <div className="relative" ref={runMenuRef}>
                ...
                {showRunMenu && (
                  <div className="absolute right-0 bottom-full mb-1 w-48 bg-cosmos-card border border-cosmos-border rounded-lg shadow-xl z-50 overflow-hidden">
                    <button
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 text-left text-xs text-zinc-300 hover:bg-zinc-800 transition-colors flex items-center gap-2 border-t border-cosmos-border"
                    >
      ...
      {validationResult && validationResult.issues.length > 0 && (
        <div className="border-t border-cosmos-border bg-red-500/5 max-h-[160px] overflow-y-auto custom-scrollbar">
      ...
      {aiFixResult && (
        <div className="border-t border-cosmos-border bg-violet-500/5 px-4 py-2 flex items-center justify-between">
      ...
      {/* Execution log panel */}
      {showLogs && execution && (
        <div className="border-t border-cosmos-border bg-cosmos-card max-h-[200px] overflow-y-auto custom-scrollbar">
          <div className="px-4 py-2 border-b border-cosmos-border flex items-center justify-between flex-shrink-0">
